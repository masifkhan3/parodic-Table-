...
elements = [
    ...
    # Function to display information about an element based on its name
def display_element_info_by_name(element_name):
    ...
    for element in elements:
        if element_name.lower() == element["Name"].lower():
            ...
            print(f"Atomic Number: {element['Atomic Number']}")
            print(f"Symbol: {element['Symbol']}")
            print(f"Atomic Mass: {element['Atomic Mass']} u")
            print(f"Electron Configuration: {element['Electron Configuration']}")
            print(f"Group: {element['Group']}")
            print(f"Period: {element['Period']}")
            print(f"Nature of Element: {element['Nature of Element']}")
            print("Properties:")
            print(f"  Physical: {element['Properties']['Physical']}")
            print(f"  Chemical: {element['Properties']['Chemical']}")
            print(f"Uses: {element['Uses']}")
            print(f"Isotopes: {', '.join(element['Isotopes'])}")
            print(f"History: {element['History']}")
            print(f"Sources: {element['Sources']}")
            print("\n")
            break
    if not found:
        print(f"No element found with the name: {element_name}")
